...
extra_files="instance-types_en.nt mappingbased-properties_en.nt labels_en.nt short-abstracts_en.nt article-categories_en.nt category-labels_en.nt skos-categories_en.nt redirects_en.nt persondata_en.nt"
compression='bz2'
output_dir='output'
output_file='dbpedia'
